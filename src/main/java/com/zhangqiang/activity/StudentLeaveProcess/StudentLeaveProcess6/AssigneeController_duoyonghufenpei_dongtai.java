...
@RestController
public class AssigneeController_duoyonghufenpei_dongtai {
    @Autowired
...
//    Activiti之多用户任务分配
    ...
    @RequestMapping("/duoyonghufenpei_dongtai")
    public String deploy() {
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("testprocesses/StudentLevaeProcess81.bpmn") // 加载资源文件
                .name("学生请假流程81") // 流程名称
                .deploy();
    ...
    @RequestMapping("/Assignee_start_duoyonghufenpei_dongtai")
    public String start() {
        Map<String,Object> variables=new HashMap<String,Object>();
        variables.put("userIds", "张三,李四,王五");
        ProcessInstance processInstance = runtimeService.
                startProcessInstanceByKey("StudentLevaeProcess81",variables);
     ...
     * 查看任务
     */
    @RequestMapping("/Assignee_findTask_duoyonghufenpei_dongtai")
...
//                .taskAssignee("李四") // 指定某个人
        ...
        List<Task> list = taskService.createTaskQuery()
                .processDefinitionKey("StudentLevaeProcess81")
                .taskCandidateUser("王五")//设置候选用户
                .list();
        //5.输出
        for (Task task : list) {
    ...
    @RequestMapping("/Assignee_shiqurenwu_dongtai")
    public String Assignee_shiqurenwu() {
        ...
        Task task = taskService.createTaskQuery()
                ...
                .singleResult();
        if (task != null) {
            taskService.claim(task.getId(), "王五");//第一个参数任务ID,第二个参数为具体的候选用户名
     ...
     * 查看任务   6.当前的用户查询自己的任务
     */
    @RequestMapping("/Assignee_shiquwan_zaichaxun_dongtai")
    ...
    /**
     7.当前用户完成自己的任务
     */
    @RequestMapping("/Assignee_completeTask_duoyonghufenpei_dongtai")
    public String completeTask() {
        //4.执行查询
        Task task = taskService.createTaskQuery()
                .processDefinitionKey("StudentLevaeProcess81")
                .taskAssignee("王五")  //设置任务的负责人
                .singleResult();
        //5.执行当前的任务
        if(task!=null){
     ...
     */
    @RequestMapping("/Assignee_renwujiaojie_dongtai")
