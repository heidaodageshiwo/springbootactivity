...
@RestController
public class AssigneeGroupController_dongtai_bingxingwangguan {
    @Autowired
...
//    方式二：使用流程变量
    ...
    @RequestMapping("/groupController_dongtaibingxingwangguan_deploy")
    public String deploy() {
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("testprocesses/StudentLevaeProcess92.bpmn") // 加载资源文件
                .name("学生请假流程92") // 流程名称
                .deploy();
        System.out.println("流程部署ID:" + deployment.getId());
        System.out.println("流程部署Name:" + deployment.getName());
        return "groupController_dongtaibingxingwangguan_deploy";
    }


    @RequestMapping("/groupController_dongtaibingxingwangguan_start")
    public String start() {
        Map<String,Object> variables=new HashMap<String,Object>();
        variables.put("groupId", "dev");
        ProcessInstance processInstance = runtimeService.
                startProcessInstanceByKey("StudentLevaeProcess92",variables);
     ...
     * 查看任务
     */
    @RequestMapping("/groupController_dongtaibingxingwangguan_findTask")
...
//                .taskAssignee("李四") // 指定某个人
        ...
        List<Task> list = taskService.createTaskQuery()
                .processDefinitionKey("StudentLevaeProcess92")
    ...
    @RequestMapping("/groupController_dongtaibingxingwangguan_shiqurenwu")
     ...
     * 查看任务   6.当前的用户查询自己的任务
     */
    @RequestMapping("/groupController_dongtaibingxingwangguan_zaichaxun")
    ...
    /**
     7.当前用户完成自己的任务
     */
    @RequestMapping("/groupController_dongtaibingxingwangguan_completeTask")
     ...
     */
    @RequestMapping("/groupController_dongtaibingxingwangguan_renwujiaojie")
