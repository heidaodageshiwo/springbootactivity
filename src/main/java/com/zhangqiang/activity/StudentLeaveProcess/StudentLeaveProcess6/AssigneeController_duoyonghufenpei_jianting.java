...
@RestController
public class AssigneeController_duoyonghufenpei_jianting {
    @Autowired
...
//    Activiti之多用户任务分配
    ...
    @RequestMapping("/duoyonghufenpei_jianting")
    public String deploy() {
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("testprocesses/StudentLevaeProcess82.bpmn") // 加载资源文件
                .name("学生请假流程82") // 流程名称
                .deploy();
    ...
    @RequestMapping("/Assignee_start_duoyonghufenpei_jianting")
    public String start() {
        Map<String,Object> variables=new HashMap<String,Object>();
        variables.put("userIds", "张三,李四,王五");
        ProcessInstance processInstance = runtimeService.
                startProcessInstanceByKey("StudentLevaeProcess82",variables);
     ...
     * 查看任务
     */
    @RequestMapping("/Assignee_findTask_duoyonghufenpei_jianting")
...
//                .taskAssignee("李四") // 指定某个人
        ...
        List<Task> list = taskService.createTaskQuery()
                .processDefinitionKey("StudentLevaeProcess82")
                .taskCandidateUser("李四")//设置候选用户
                .list();
        //5.输出
        for (Task task : list) {
    ...
    @RequestMapping("/Assignee_shiqurenwu_jianting")
    public String Assignee_shiqurenwu() {
        ...
        Task task = taskService.createTaskQuery()
                ...
                .singleResult();
        if (task != null) {
            taskService.claim(task.getId(), "李四");//第一个参数任务ID,第二个参数为具体的候选用户名
     ...
     * 查看任务   6.当前的用户查询自己的任务
     */
    @RequestMapping("/Assignee_shiquwan_zaichaxun_jianting")
    ...
    /**
     7.当前用户完成自己的任务
     */
    @RequestMapping("/Assignee_completeTask_duoyonghufenpei_jianting")
    public String completeTask() {
        //4.执行查询
        Task task = taskService.createTaskQuery()
                .processDefinitionKey("StudentLevaeProcess82")
                .taskAssignee("李四")  //设置任务的负责人
                .singleResult();
        //5.执行当前的任务
        if(task!=null){
     ...
     */
    @RequestMapping("/Assignee_renwujiaojie_jianting")
